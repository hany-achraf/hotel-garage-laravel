...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('security-guards')" :active="request()->routeIs('security-guards')" wire:navigate>
                        {{ __('Guards') }}
                    </x-nav-link>

                    <x-nav-link :href="route('gates')" :active="request()->routeIs('gates')" wire:navigate>
                        {{ __('Gates') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('security-guards')" :active="request()->routeIs('security-guards')" wire:navigate>
                    {{ __('Guards') }}
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="route('gates')" :active="request()->routeIs('gates')" wire:navigate>
                    {{ __('Gates') }}
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="route('visits')" :active="request()->routeIs('visits')" wire:navigate>
                    {{ __('Visits') }}
                </x-responsive-nav-link>
        </div>
