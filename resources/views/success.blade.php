    ...
    <div
        ...
        <div class="relative w-full max-w-lg p-6 bg-white rounded-lg shadow-lg">
            ...
            <div class="my-8 text-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="inline w-14 shrink-0 fill-green-500"
                    viewBox="0 0 512 512">
                    <path
                ...
                <h4 class="mt-4 text-xl font-semibold text-gray-800">Payment completed successfully!</h4>
